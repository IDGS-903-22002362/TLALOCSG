...
namespace TLALOCSG.Migrations
{
    ...
    [Migration("20250812105942_AddContactMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TLALOCSG.Models.AccessRequest", b =>
                {
                    ...
                    b.HasIndex("Email")
                        .HasDatabaseName("IX_AccessRequests_Email");

                    b.HasIndex("Email", "Status")
                        .HasDatabaseName("IX_AccessRequests_Email_Status");
            ...
            modelBuilder.Entity("TLALOCSG.Models.ContactMessage", b =>
                {
            ...
            modelBuilder.Entity("TLALOCSG.Models.InstallTier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MinQty", "MaxQty")
                        .HasDatabaseName("IX_InstallTiers_Range");

                    b.ToTable("InstallTiers", (string)null);
            ...
            modelBuilder.Entity("TLALOCSG.Models.Quote", b =>
                {
                    ...
                    b.Property<decimal>("InstallBase")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("TLALOCSG.Models.StateRate", b =>
                {
                    b.Property<string>("StateCode")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<decimal>("TransportPerKm")
                        .HasColumnType("decimal(18,2)");

                    b.HasKey("StateCode");

                    b.ToTable("StateRates", (string)null);
            ...
            modelBuilder.Entity("TLALOCSG.Models.TicketMessage", b =>
                {
                    ...
                    b.HasIndex(new[] { "TicketId" }, "IX_TicketMessages_TicketId");
            ...
            modelBuilder.Entity("TLALOCSG.Models.ContactMessage", b =>
                {
                    b.HasOne("TLALOCSG.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("TLALOCSG.Models.TicketMessage", b =>
                {
                    b.HasOne("TLALOCSG.Models.Ticket", "Ticket")
                        .WithMany()
